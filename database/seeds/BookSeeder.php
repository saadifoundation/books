    ...
    public function run()
    {
        $books_data = [
            ...
            [
                ...
                'intro' => <<<INTRO
                کتاب حاضر، جلد نخست از مجموعه «چارچوب» است که دستور زبان فارسی را برای فارسی‌آموزان خارجی در سطح مقدماتی و پیش‌میانی آموزش می‎دهد. مهمترین ویژگی کتاب چارچوب این است که نخستین کتابی است که زبان فارسی را بر اساس « دستور آموزشی » تدریس می‌کند و برای آموزش دستور بر نقش و کاربرد آن در «ارتباط» تمرکز دارد.
                این کتاب متشکل از 35 درس است که در 12 فصل دسته بندی شده‌اند. هر درس تمرکز بر یک کارکرد زبانی دارد که در قالب یکی از ساختهای دستوری آموزش داده می‌شود. قالب درس‎ها به گونه‎ای است که زبان‌آموز کارکرد مناسب را در ساختار دستوری مورد نظر را تمرین می‎کند و در نهایت، در دو تمرین پایانی موفق به تولید و کاربرد درست ساختار دستوری در موقعیت موردنظر به صورت نوشتاری و گفتاری می‎شود.
                INTRO,
                'intro_video' => null,
                'teaching_video' => null,
                'elearning_link' => null,
            ...
            [
                ...
                'intro' => <<<INTRO
                جلد اول و دوم از مجموعۀ آموزش کاربردی واژه، ویژه‌ فارسی‌آموزان سطح مقدماتی و پیش‌میانی است که با تصویرگری مبتنی بر واقعیت، در مجموع حدود 1600 واژه‌های عینی و پربسامد را آموزش می‌دهد و به طور علمی و با ظرافت، تفاوت‌های صورت گفتاری و نوشتاری زبان فارسی را معرفی می‌کند و زبان‌آموزان را برای کاربرد آن در جامعه فارسی زبان آماده می‌سازد. از آنجایی که جلد اول و دوم این مجموعه به تمام مهارتهای زبانی پرداخته است، می‌تواند در یک دوره آموزشی به عنوان کتاب اصلی برای آموزش زبان فارسی در نظر گرفته شود. 
                هر جلد شامل 30 درس است که در قالبی 6 حوزه واژگانی دسته بندی شده اند. یعنی جلد اول و دوم مجموعا 12 حوزه واژگانی مختلف را ‌پوشش می‌دهند. هر حوزه  شامل 5 درس چهار صفحه‏‌ای و یک تمرین مرور در انتهای آن است. ترتیب چینش تمرینها از نوع تشخیصی به تولیدی است که در نهایت زبان‌آموز موفق می‌شود در تمرین «درباره شما» به زندگی واقعی خود فکر کند و با واژه‌های جدیدی که آموخته است درباره خود صحبت کند.
                INTRO,
                'intro_video' => null,
                'teaching_video' => null,
                'elearning_link' => null,
