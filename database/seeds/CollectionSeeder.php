    ...
    public function run()
    {
        $collections_data = [
            ...
            [
                ...
                'intro' => <<<INTRO
                «چارچوب» مجموعه‌ای 3 جلدی است که با هدف آموزش دستور زبان فارسی  برای سطوح مقدماتی پیش‌میانی،  میانیفوق میانی و پیشرفته برای فارسی‌آموزان خارجی طراحی شده است. با توجه به اینکه این کتاب بر تمام مهارتهای زبانی توجه داشته است، می‌تواند به عنوان محتوایی مستقل برای آموزش زبان فارسی در یک دوره آموزشی درنظر گرفته شود.
                مهمترین ویژگی کتاب چارچوب این است که بر پایه رهیافتهای علمی، برآمده از آخرین دستاوردها، تدوین شده است و نخستین کتابی است که زبان فارسی را بر اساس « دستور آموزشی » تدریس می‌کند. در این مسیر، برای آموزش دستور بر نقش و کاربرد آن در «ارتباط»  تمرکز دارد و به خوبی رابطه « معنا » ، « صورت » و «کارکرد» را در این مجموعه مشاهده می‌کنید. همچنین در گام آخر، با ارائه توضیح دستوری در پایان هر فصل، آموزش « مستقیم » و توصیف قواعد دستوری به صورت «سنتی » را نیز در نظر داشته است.
                INTRO,
            ],
            [
                ...
                'intro' => <<<INTRO
                مجموعۀ «آموزش کاربردی واژه‌» به آموزش واژه‌ها و عبارات پرکاربرد زبان فارسی که در بافت واقعی زبان استفاده می‌شود می‌پردازد و در سه جلد تألیف شده است. در جلد اول و دوم که ویژه‌ فارسی‌آموزان سطح مقدماتی و پیش‌میانی است، با تصویرگری مبتنی بر واقعیت، حدود 1600 واژه و عبارت عینی و پربسامد را آموزش می‌دهد و به طور علمی و با ظرافت، تفاوت‌های صورت گفتاری و نوشتاری زبان فارسی را معرفی می‌کند و زبان‌آموزان را برای کاربرد آن در جامعه فارسی زبان آماده می‌کند. هر جلد شامل 30 درس است که در قالبی 6 حوزه واژگانی دسته بندی شده اند. یعنی جلد اول و دوم مجموعا 12 حوزه واژگانی مختلف را ‌پوشش می‌دهد.
                جلد سوم این مجموعه برای فارسی‌آموزان سطح میانی و فوق‌میانی تألیف شده است و  بیش از 1300 واژه مفهومی و انتزاعی ‌را با دو رویکرد صریح  و ضمنی آموزش می‎دهد. این کتاب برای زبان‌ آموزانی که به منظور آزمونهای رسمی زبان فارسی و ورود به دانشگاه‌های ایران آماده می‌شوند، بسیار مناسب است. آنها می‌توانند با واژه‌‏های عمومی و نیمه‌تخصصی بسیاری آشنا شوند.
                INTRO,
            ],
            [
                'title' => 'شیراز',
                ...
                3. کارکردهای زبانی در بخش «گفتگو» ارائه شده‌اند. در درس‌های اول و دوم هر بخش صفحه‌ای تحت عنوان «گفتگو» وجود دارد و شامل یک موقعیت داستانی منسجم در قالب سه یا چهار گفتگوی کوتاه است. این گفتگوها علاوه بر پوشش کارکرد/ کارکردهای مورد نظر درس، محتوای واژگانی و دستوری درس را نیز در برمی‌گیرند.
                4. فعالیت‌های تمرینی این مجموعه بر مبنای رویکرد ارتباطی و تکلیف‌محور تدوین و اغلب آنها به صورت فعالیت‌هایی تعاملی و با عنوان‌های تمرین‌های «دونفره» یا «گروهی» ارائه شده‌اند.
                5. از ویژگی‌های منحصربه‌فرد این مجموعه، درنظرگرفتن شخصیت‌های داستانی ثابت در کل مجموعه و تصویرسازی آنها به منظور جذابیت و همراهی دانش‌آموزان بوده است.
                6. هر بخش این مجموعه، با یک صفحۀ «آماده‌سازی» آغاز و با صفحه‌ای با عنوان «مرور و تمرین» به پایان می‌رسد. صفحه‌ی «آماده‌سازی» شامل یک فعالیت ساده‌ی تصویری است که فارسی‌آموزان را برای ورود به آن بخش آماده می‌کند. در پایان هر بخش نیز به منظور یادآوری و مرور مطالب آموخته‌شده، تمرین‌هایی ارائه گردیده است. آخرین فعالیتی که در این قسمت گنجانده شده، گوش‌دادن به یک موسیقی است که شعر آن با توجه به محتوای آن بخش نوشته شده و فارسی‌آموزان می‌توانند با گوش‌دادن به آن و هم‌خوانی‌اش در کلاس، آموخته‌هایشان در آن بخش را تثبیت کنند.
                7. در انتهای کتاب یک واژه‌نامه‌ی فارسی- انگلیسی- عربی ارائه شده است. در این قسمت، فارسی‌آموزان می‌توانند معادل عربی و انگلیسی واژه‌های به کار رفته در کتاب را پیدا کرده و تلفظ درست آنها را ملاحظه نمایند.
                INTRO,
            ],
            [
                'title' => 'سفر به ایران',
