    ...
    public function run()
    {
        $books_data = [
            ...
            [
                ...
                <center><a href='/storage/audio_zip_old/mina1.zip' target='_blank'><img src='/storage/covers_old/mina1.jpg' alt='مینا 1 قدیمی' class='w-25 rounded'></a></center>
                INTRO,
                'status_id' => Status::firstWhere('title_abbr', 'released')->id,
                'intro_video' => null,
                'teaching_intro_video' => 'mwv7z',
                'teaching_detailed_video' => 'n3D0U',
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/مینا-1',
            ...
            [
                ...
                مینا مجموعه‌ای است چند‌رسانه‌ای، که امکان می‌دهد حجم قابل‌توجّهی از گفتارِ روزمره فارسی‌زبانان را در بافت‌ها و موقعیت‌های گوناگون بشنوید.
                برای دانلود فایل‌های صوتی نسخۀ قدیمی مینا روی لینک زیر کلیک کنید:
                <center><a href='/storage/audio_zip_old/mina2.zip' target='_blank'><img src='/storage/covers_old/mina2.jpg' alt='مینا 2 قدیمی' class='w-25 rounded'></a></center>
                INTRO,
                'status_id' => Status::firstWhere('title_abbr', 'released')->id,
                'intro_video' => null,
                'teaching_intro_video' => 'mwv7z',
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/مینا-2',
            ...
            [
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/مینا-3',
            ...
            [
                ...
                'teaching_detailed_video' => 'n3D0U',
                'elearning_link' => 'https://mina.saadifoundation.ir',
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/8491346',
            ...
            [
                ...
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/5126057',
                'index_file' => 'indexes/enjoyreading1.pdf',
                'sample_file' => 'samples/enjoyreading1.pdf',
                'buying_link' => 'https://core.saadifoundation.ir/product/لذت-خواندن-1',
            ...
            [
                ...
                'teaching_detailed_video' => 'PZBFm',
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/6237981',
            ...
            [
                ...
                'status_id' => Status::firstWhere('title_abbr', 'released')->id,
                'intro_video' => null,
                'teaching_intro_video' => '4z386',
                'teaching_detailed_video' => 'UHxXV',
                'elearning_link' => null,
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/ایران-شناسی-1',
            ...
            [
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/ایران-شناسی-2',
            ...
            [
                ...
                'intro' => <<<'INTRO'
                <div dir="ltr" lang="en">In learning Persian, the first step is very important, even vital. In this first step, Persian learners should become accustomed to the language In order to enjoy learning it. If Persian learners are presented with a transparent and clear picture of the language, they are more likely to learn it with speed and enjoyment. The book First Step Persian focuses on this goal and was written relying on the rich and varied experiences of Persian teachers and professors in Iran and abroad. The most important purpose of First Step Persian is to make learners use Persian from the very beginning of the learning process. All tasks are communicative; as a result, each task requires a focused, linguistic performance. 
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/گام-اول-فارسی-انگلیسی',
            ...
            [
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/گام-اول-فارسی-عربی',
            ...
            [
                ...
                'teaching_detailed_video' => 'DQxvc',
                'elearning_link' => 'http://s1f.ir/e1ststep',
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/9084842',
            ...
            [
                ...
                'collection_id' => Collection::firstWhere('title_abbr', '1ststep')->id,
                'intro' => <<<'INTRO'
                <div dir="ltr" lang="zh">学习波斯语,关键在于走好“第一步”。波斯语学习者只有在这一阶段逐步熟悉波 斯语、了解波斯语,才能获得学习的乐趣。如果学生们从一开始就能对波斯语有一个清 晰的认识,那么学习起来就更加得心应手。这正是我们出版《第一步》的初衷。《第一 步》吸收了多年来伊朗国内外广大波斯语师生的丰富经验编写而成,旨在让波斯语学习 者一开始就使用波斯语。课本中所有的练习都是彼此联系的,因为完成每项练习都需要 一种有目的语言行为。
            ...
            [
                ...
                'teaching_detailed_video' => 'DQxvc',
                'elearning_link' => 'http://s1f.ir/e1ststep',
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/9255299',
            ...
            [
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/گام-اول-فارسی-ترکی',
            ...
            [
                ...
                'status_id' => Status::firstWhere('title_abbr', 'released')->id,
                'intro_video' => null,
                'teaching_intro_video' => 'NDdeU',
                'teaching_detailed_video' => 'OgiUc',
                'elearning_link' => 'https://s1f.ir/persiangrammar',
            ...
            [
                ...
                'teaching_detailed_video' => 'OgiUc',
                'elearning_link' => 'https://s1f.ir/persiangrammar',
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/8494281',
            ...
            [
                ...
                'status_id' => Status::firstWhere('title_abbr', 'released')->id,
                'intro_video' => null,
                'teaching_intro_video' => 'm9IiB',
                'teaching_detailed_video' => 'ydeTz',
                'elearning_link' => 'https://core.saadifoundation.ir/product/شماره-سریال-نرمافزار-واژه',
            ...
            [
                ...
                'collection_id' => Collection::firstWhere('title_abbr', 'persianinuse')->id,
                'intro' => <<<'INTRO'
                جلد سوم از مجموعۀ «آموزش کاربردی واژه» برای فارسی‌آموزان سطح میانی و فوق‌میانی تألیف شده است و ساختار آن با دو جلد پیشینِ این مجموعه متفاوت است. مهم‌ترین ویژگی‎ این کتاب، آموزش هدفمند واژه‌‏های عمومی و نیمه‌تخصصی زبان فارسی در قالب متن‌های جذاب و معنی‎دار است. راهبرد اصلی این کتاب، آموزش واژه بر اساس فرایند تکرارِ هدفمند است. در آموزش واژه‌های موردنظر، مؤلفان تلاش کرده‌اند با اتخاذ یک رویکرد اصولی، نقش یادگیرنده را در یادگیری زبان فارسی به‌طور عام و واژه‌های آن به طور خاص، مورد تأکید قرار دهند.
            ...
            [
                ...
                'status_id' => Status::firstWhere('title_abbr', 'released')->id,
                'intro_video' => null,
                'teaching_intro_video' => 'STqGs',
                'teaching_detailed_video' => 'moV21',
                'elearning_link' => null,
                ...
                'buying_link' => 'https://core.saadifoundation.ir/product/شیراز-1',
            ...
            [
                ...
                'teaching_detailed_video' => 'moV21',
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/8499089',
            ...
            [
                ...
                'teaching_detailed_video' => 'moV21',
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/9015702',
                'index_file' => 'indexes/shiraz3.pdf',
            ...
            [
                ...
                'teaching_detailed_video' => null,
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/8777208',
            ...
            [
                ...
                'teaching_detailed_video' => null,
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/3751853',
                'index_file' => null,
                'sample_file' => 'samples/khomreh.pdf',
                'buying_link' => 'https://www.amazon.de/Water-Urn-English-Caroline-Croskery-ebook/dp/B00VJFWHOC',
                'ebuying_link' => null,
                'audio_link' => null,
                'levels' => null,
                'users' => [
            ...
            [
                ...
                'teaching_detailed_video' => null,
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/7292551',
                ...
                'users' => [
                    [
                        'model' => User::firstWhere('name_en', 'Behrouz-MahmoodiBakhtiari'),
                        'role_title' => Role::firstWhere('title_abbr', 'writer'),
                    ],
                    [
                        'model' => User::firstWhere('name_en', 'Shima-Eslamifakhr'),
                        'role_title' => Role::firstWhere('title_abbr', 'writer'),
                    ],
                    [
                        'model' => User::firstWhere('name_en', 'Mahdieh-Abedi'),
                        'role_title' => Role::firstWhere('title_abbr', 'writer'),
                    ],
                    [
                        'model' => User::firstWhere('name_en', 'Babak-Nobahari'),
            ...
            [
                ...
                'teaching_detailed_video' => 'DQxvc',
                'elearning_link' => 'http://s1f.ir/e1ststep',
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/8495537',
            ...
            [
                ...
                'teaching_detailed_video' => null,
                'elearning_link' => null,
                'bibliography_link' => 'http://opac.nlai.ir/opac-prod/bibliographic/9085142',
        ...
        foreach ($books_data as $book_data) {
            ...
            $book->teaching_intro_video = $book_data['teaching_intro_video'];
            $book->teaching_detailed_video = $book_data['teaching_detailed_video'];
